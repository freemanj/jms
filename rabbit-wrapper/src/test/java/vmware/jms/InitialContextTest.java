...
public class InitialContextTest {
    ...
    private Properties createProperties() {
        ...
        env.put(RMQContext.CONNECTIONFACTORY_PREFIX + FAKE_JNDI_BROKER_NAME_FOR_TEST, "amqp://guest:guest@localhost/testpath");
        ...
        env.put(RMQContext.QUEUE_PREFIX + "queue0" + RMQContext.MESSAGE_CLASS_NAME_SUFFIX, RMQContext.MESSAGE_CLASS_DEFAULT);
        return env;
    }
